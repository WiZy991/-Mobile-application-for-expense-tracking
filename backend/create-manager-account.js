/**
 * Скрипт для создания аккаунта менеджера
 * 
 * Использование:
 * node create-manager-account.js <email> <password> <name>
 * 
 * Пример:
 * node create-manager-account.js manager@worldcashbox.ru Manager123! "Петр Петров"
 */
...
async function createManagerAccount() {
  ...
  if (args.length < 3) {
    console.log('Использование: node create-manager-account.js <email> <password> <name>');
    console.log('');
    console.log('Пример:');
    console.log('node create-manager-account.js manager@worldcashbox.ru Manager123! "Петр Петров"');
    process.exit(1);
  }
  ...
  try {
    console.log('🔐 Создание аккаунта менеджера...');
    ...
    console.log('');
    console.log('✅ Аккаунт менеджера успешно создан!');
    console.log('');
